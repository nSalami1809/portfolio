...
const navItems = [
  ...
  { href: '/admin/offers', label: 'Mes Offres', icon: 'M20.59 13.41 13.42 20.58a2 2 0 01-2.83 0L2.83 12.83A2 2 0 012 11.17V4a2 2 0 012-2h7.17a2 2 0 011.42.59l7.98 7.99a2 2 0 01.02 2.83z M7 7h.01' },
  ...
  { href: '/admin/quotes', label: 'Devis', icon: 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8' },
  { href: '/admin/calendar', label: 'Calendrier', icon: 'M8 2v4M16 2v4M3.5 9h17M4 4h16a1 1 0 011 1v15a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1z' },
  { href: '/admin/prospects', label: 'Prospects', icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M9 11a4 4 0 100-8 4 4 0 000 8z M23 21v-2a4 4 0 00-3-3.87 M16 3.13a4 4 0 010 7.75' },
