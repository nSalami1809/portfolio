...
import type { PersonalInfo, Experience, Education, Skill } from '@/types'
...
export default function ResumeView({ personal, experiences, educations, skills, t }: Props) {
  return (
    <div className="relative">
      ...
      <section className="mb-20">
        <FadeIn>
          <h2 className="section-label mb-10">{t.experiencesLabel}</h2>
        </FadeIn>
      ...
      <section className="mb-20">
        <FadeIn>
          <h2 className="section-label mb-10">{t.skillsLabel}</h2>
        </FadeIn>
      ...
      <section>
        <FadeIn>
          <h2 className="section-label mb-10">{t.educationLabel}</h2>
        </FadeIn>
