...
export default function VisionView({ vision, t }: { vision: VisionData; t: Dictionary['vision'] }) {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20">
      ...
      {/* ── Sections texte ───────────────────────────────────────────────── */}
      {[
        { label: t.philosophyLabel, paragraphs: vision.philosophie, key: 'philosophie' },
        { label: t.approachLabel,    paragraphs: vision.approche,    key: 'approche' },
      ...
      <div className="divider" />
      <FadeIn>
        <h2 className="section-label mb-10">{t.valuesLabel}</h2>
      </FadeIn>
