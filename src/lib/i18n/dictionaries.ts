...
const fr = {
  ...
  devis: {
    ...
    companyPlaceholder: 'Ma Société SARL',
    addressLabel: 'Adresse (optionnel)',
    addressPlaceholder: 'Libreville, Gabon',
    ...
    errorRequired: 'Merci de renseigner votre nom et de choisir au moins une prestation.',
...
const en: typeof fr = {
  ...
  devis: {
    ...
    errorRequired: 'Please enter your name and pick at least one service.',
